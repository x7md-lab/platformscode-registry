...
export function TabsList({
  ...
  return (
    ...
    >
      {props.children}
      <BaseTabs.Indicator className="absolute bottom-0 left-0 z-30 h-[3px] w-[var(--active-tab-width)] translate-x-[var(--active-tab-left)] rounded-full bg-primary-accent transition-all duration-200" />
    </BaseTabs.List>
  )
}
  ...
  return (
    <BaseTabs.Tab
      className={cn(
        ...
        "after:absolute after:inset-x-4 after:bottom-0 after:z-20 after:h-[3px] after:rounded-full after:bg-primary-accent/40 after:opacity-0 after:transition-opacity",
        "hover:after:opacity-100 data-[active]:after:opacity-0",
        "focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/40",
        "data-[active]:bg-transparent data-[active]:text-primary-accent",
        className
      )}
      {...props}
    />
